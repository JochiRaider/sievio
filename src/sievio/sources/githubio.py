...
from ..core.licenses import apply_license_to_context, detect_license_in_zip
...
def parse_github_url(url: str) -> RepoSpec | None:
...
class GitHubZipSource(Source):
    ...
    def __init__(
        ...
        *,
        ...
        http_client: safe_http.SafeHttpClient | None = None,
    ) -> None:
